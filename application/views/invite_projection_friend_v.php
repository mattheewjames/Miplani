									...
									<div class="variants_selects">
									   ...
									   <div class="row">
											...
											<div class="col-md-12" style="text-align: right;">
												...
												<button id="invite_friend_form_btn" name="invite_friend_form_btn" type="submit" class="dark-btn" onClick="form_data_validation('<?php echo base64_encode(8);?>','invite friend','invite_friend');">Invite friend</button>
											</div>
										</div>
									</div>
								</form>
