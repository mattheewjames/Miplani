					...
					<form id="dream_projection_form" name="dream_projection_form" method="" action="">	       
						<div class="col-lg-12 col-md-12" id="main-projection-data">
							<div class="contact_message form form-bg">
								<h3>Create your dreamed financial goal in 6 months</h3>
								<div class="col-md-12">
											<div class="red-warning">
												<span class="float-right">
													<i class="fa fa-times" aria-hidden="true"></i>
												</span>
												<p>For the Freemium Plan, the maximum amount SHOULD NOT exceed 30,000 &euro;. Being the highest Billing to be considered in other plans: 100,000,000 &euro;. For higher values,</p>
											</div>
										</div>
								<div class="col-md-3">
								 ...
								 <div class="col-md-12 row p-0 m-mb-0 m-0" id="financial-goals">
									...
									<div class="col-md-2">
										...
										<input type="number"  name="advertising_expenses" id="advertising_expenses" onkeypress="return isNumbericKey(event);" min="1" max="100">
									</div>
								</div>
								 <div class="col-md-12 text-right mb-3 p-0">
									<button class="expense-btn check-btn" type="button" onclick="get_dream_projection_calculation('<?php echo base64_encode('6 Months');?>');">Calculate</button>
								</div>
 								<div class="col-md-12 row m-0 p-0 mt-2">
									<div class="col-md-6 col-6 text-left p-0"></div>
									<div class="col-md-6 col-6 text-right p-0">
										<button type="button" class="save-btn m-0" onclick="create_dream_financial_goal('<?php echo base64_encode('6 Months');?>');"> <?php echo $this->lang->line('lang_save_label');?></button>
									</div>
								</div>
