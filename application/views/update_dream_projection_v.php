								...
								<div class="contact_message form form-bg">
									...
									<div class="col-md-3">
									 ...
									 <div class="col-md-12 text-right mb-3 p-0">
										<button class="expense-btn check-btn" type="button" onclick="get_dream_projection_calculation('<?php echo base64_encode($row->projection_type);?>');">Calculate</button>
									</div>
									<div class="col-md-12 row m-0 p-0">
										...
										<div class="col-md-6 col-6 text-right p-0 form-btns">
											...
											<button type="button" class="save-btn" onclick="update_dream_financial_goal('<?php echo base64_encode($row->projection_type);?>');"> <?php echo $this->lang->line('lang_save_label');?></button>
										</div>
									</div>
