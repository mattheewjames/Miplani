			...
			<div class="container">
				<div class="col-md-12 content" id="user_form_data">
					<form id="dream_projection_form" name="dream_projection_form" method="" action="">	       
						<div class="col-lg-12 col-md-12" id="main-projection-data">
							<div class="contact_message form form-bg">
								<h3>Create your dreamed financial goal in 3 months</h3>
								<div class="col-md-12">
								...
								<div class="col-md-3">
								 ...
								 <div class="col-md-12 row p-0 m-mb-0 m-0" id="financial-goals">
										<div class="col-md-2">
											...
											<input type="text" name="average_product_price" id="average_product_price" pattern="^\$\d{1,3}(,\d{3})*(\.\d+)?$" data-type="">
										</div>
										<div class="col-md-2">
											<label class="fw-600">% of operating expenses over revenue</label>
											<input name="operating_expenses" id="operating_expenses" type="number" onkeypress="return isNumbericKey(event);" min="1" max="100">
										</div>
										<div class="col-md-2">
											<label class="fw-600 conversion-label">% conversion rate</label>
											<input name="conversion_rate" id="conversion_rate" type="number" onkeypress="return isNumbericKey(event);" min="1" max="100">
										</div>
										<div class="col-md-2">
											<label class="fw-600">% of cost of the products / services over</label>
											<input name="average_product_sold_cost" id="average_product_sold_cost" type="number" onkeypress="return isNumbericKey(event);" min="1" max="100">
										</div>
										<div class="col-md-2">
								 ...
								 <div class="col-md-12 text-right mb-3 p-0">
									<button class="expense-btn check-btn" type="button" onclick="get_dream_projection_calculation('<?php echo base64_encode('3 Months');?>');">Calculate</button>
								</div>
								...
								<div class="col-md-12 row m-0 p-0 mt-2">
									...
									<div class="col-md-6 col-6 text-right p-0 ">
										<button type="button" class="save-btn m-0" onclick="create_dream_financial_goal('<?php echo base64_encode('3 Months');?>');"> <?php echo $this->lang->line('lang_save_label');?></button>
									</div>
								</div>
