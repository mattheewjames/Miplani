 						...
 						$html = '<div class="col-lg-12 col-md-12">
								<div class="contact_message form form-bg">
									...
									<div class="col-md-12 text-right p-0">
										<button type="button" class="save-btn" onclick="load_user_projection_wizard(\'1\',\''.$projection_id.'\',\'save\')"> '.$this->lang->line('lang_save_label').'</button>
								...
								<form id="contact-form" method="" action="">
									...
									<div class="col-md-12 row m-0 p-0">
										...
										<div class="col-md-6 col-6 text-right p-0 form-btns">
											  <button type="button" class="save-btn" onclick="load_user_projection_wizard(\''.$new_step.'\',\''.$projection_id.'\',\'save\')"> '.$this->lang->line('lang_save_label').'</button>
